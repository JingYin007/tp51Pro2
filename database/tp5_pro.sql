...
INSERT INTO `tp5_xadmins` VALUES ('3', '1', 'niuNengx@admin', 'cms/images/headshot/niuNeng.png', '$2y$10$55Uweztnsf4wQyjxoATBNeE7WIChrZzQ2HKEuy5rJL3LGVktlHgdy', '2020-06-02 19:51:04', '1', 'HELLO');
INSERT INTO `tp5_xadmins` VALUES ('4', '2', 'wuHuang@admin', 'cms/images/headshot/wuHuang.png', '$2y$10$jfzlnfALzEeQGOuTSOhO.OiePC3VadvFprHLteRIyQj0Te2Pum9/O', '2020-11-12 19:48:25', '1', '世界上没有两片完全相同的叶子！！');
...
CREATE TABLE `tp5_xadmin_roles` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx` (`list_order`)
) ENGINE=MyISAM AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COMMENT='管理员角色表';

-- ----------------------------
-- Records of tp5_xadmin_roles
-- ----------------------------
INSERT INTO `tp5_xadmin_roles` VALUES ('1', '终级管理员', '138|139|140|141|1|2|29|30|31|161|7|41|42|6|38|39|3|4|33|34|5|36|37|92|135|93|94|95|137|61|66|62|63|65|76|77|80|78|73|75|49|50|136|54|55|58|70|72|153|48|51|52|53|59|142|143|144|67|68|69|99|145|146|148|147|149|150|133|134|151|155|157|156|158|159|', '2021-05-20 19:45:58', '1', '1');
...
INSERT INTO `tp5_xarticle_points` VALUES ('4', '4', '0', '', 'home/images/article4.png', '人都是对喜欢的东西最上心。他若真的在乎你，一分一秒都不想失去你的消息，更不会不时玩消失，不会对你忽冷忽热，因为他比你还害怕失去。所有的不主动都是由于不喜欢，喜欢你的人永远不忙。', '1', '1', '', '', '');
...
CREATE TABLE `tp5_xcms_logs` (
  ...
  KEY `tag_index` (`tag`)
) ENGINE=MyISAM AUTO_INCREMENT=291 DEFAULT CHARSET=utf8mb4 COMMENT='业务 行为记录日志表';
...
INSERT INTO `tp5_xcms_logs` VALUES ('279', 'GOODS', '1', '商品修改成功', '1', '2021-05-20 17:49:54');
INSERT INTO `tp5_xcms_logs` VALUES ('280', 'GOODS', '8', '删除商品', '1', '2021-05-20 17:50:04');
INSERT INTO `tp5_xcms_logs` VALUES ('281', 'ARTICLE', '2', '文章更新', '1', '2021-05-20 17:58:38');
INSERT INTO `tp5_xcms_logs` VALUES ('282', 'ARTICLE', '3', '取消推荐', '1', '2021-05-20 18:02:03');
INSERT INTO `tp5_xcms_logs` VALUES ('283', 'ARTICLE', '3', '推荐商品', '1', '2021-05-20 18:02:04');
INSERT INTO `tp5_xcms_logs` VALUES ('284', 'ARTICLE', '1', '取消推荐', '1', '2021-05-21 13:54:04');
INSERT INTO `tp5_xcms_logs` VALUES ('285', 'ARTICLE', '1', '推荐商品', '1', '2021-05-21 13:54:06');
INSERT INTO `tp5_xcms_logs` VALUES ('286', 'ARTICLE', '4', '文章更新', '1', '2021-06-21 18:17:55');
INSERT INTO `tp5_xcms_logs` VALUES ('287', 'ARTICLE', '1', '文章更新', '1', '2021-06-21 18:19:27');
INSERT INTO `tp5_xcms_logs` VALUES ('288', 'ARTICLE', '1', '文章更新', '1', '2021-06-21 18:22:57');
INSERT INTO `tp5_xcms_logs` VALUES ('289', 'ARTICLE', '4', '推荐商品', '1', '2021-06-21 18:29:07');
INSERT INTO `tp5_xcms_logs` VALUES ('290', 'ARTICLE', '2', '取消推荐', '1', '2021-06-21 18:40:30');

-- ----------------------------
-- Table structure for tp5_xcms_op_logs
-- ----------------------------
DROP TABLE IF EXISTS `tp5_xcms_op_logs`;
CREATE TABLE `tp5_xcms_op_logs` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb4 COMMENT='CMS 行为日志记录表';

-- ----------------------------
-- Records of tp5_xcms_op_logs
-- ----------------------------
INSERT INTO `tp5_xcms_op_logs` VALUES ('1', '1', 'moTzxx@admin', '200', 'POST', '/cms/login/ajaxLogin', '登录系统', '2021-06-21 18:51:04.463');
INSERT INTO `tp5_xcms_op_logs` VALUES ('2', '1', 'moTzxx@admin', '200', 'POST', '/cms/admin/editRole/5', '更新了id为 5 的角色权限', '2021-06-21 19:07:05.949');
INSERT INTO `tp5_xcms_op_logs` VALUES ('3', '1', 'moTzxx@admin', '200', 'POST', '/cms/admin/editRole/5', '更新了id为 5 的角色权限', '2021-06-21 19:08:03.099');
INSERT INTO `tp5_xcms_op_logs` VALUES ('4', '1', 'moTzxx@admin', '200', 'POST', '/cms/admin/editRole/5', '更新了id为 5 的角色信息', '2021-06-21 19:08:53.684');
INSERT INTO `tp5_xcms_op_logs` VALUES ('5', '1', 'moTzxx@admin', '200', 'POST', '/cms/login/ajaxLogin', '登录了系统', '2021-06-22 09:50:27.243');
INSERT INTO `tp5_xcms_op_logs` VALUES ('6', '1', 'moTzxx@admin', '200', 'POST', '/cms/admin/editRole/5', '更新了id为 5 的角色信息', '2021-06-22 09:50:59.668');
INSERT INTO `tp5_xcms_op_logs` VALUES ('7', '1', 'moTzxx@admin', '200', 'POST', '/cms/admin/editRole/5', '更新了id为 5 的角色信息', '2021-06-22 09:53:43.328');
INSERT INTO `tp5_xcms_op_logs` VALUES ('8', '1', 'moTzxx@admin', '200', 'POST', '/cms/admin/editRole/5', '更新了id为 5 的角色信息', '2021-06-22 09:58:01.126');
INSERT INTO `tp5_xcms_op_logs` VALUES ('9', '1', 'moTzxx@admin', '200', 'POST', '/cms/admin/editRole/5', '更新了id为 5 的角色信息', '2021-06-22 09:59:46.873');
INSERT INTO `tp5_xcms_op_logs` VALUES ('10', '1', 'moTzxx@admin', '200', 'POST', '/cms/admin/editRole/5', '更新了id为 5 的角色信息', '2021-06-22 10:01:31.429');
INSERT INTO `tp5_xcms_op_logs` VALUES ('11', '1', 'moTzxx@admin', '200', 'POST', '/cms/login/ajaxLogin', '登录了系统', '2021-06-23 16:58:03.210');
...
INSERT INTO `tp5_xgoods` VALUES ('8', '商品测试数据', '21', '18', 'upload/20201110/3f2d55e101aa2a6a41e47408d128c21e.jpg', '', 'sd', '12', '<p>sd4</p>', '4.00', '1.00', '[{\"spec_id\":\"44\",\"spec_name\":\"颜色\",\"spec_info\":[{\"spec_id\":47,\"spec_name\":\"铂金银\"}]},{\"spec_id\":\"45\",\"spec_name\":\"版本\",\"spec_info\":[{\"spec_id\":48,\"spec_name\":\"WF-1000XM3随身降噪\"},{\"spec_id\":49,\"spec_name\":\"WF-XB700防水运动\"}]}]', '330', '2020-11-10 14:34:49', '2021-05-20 17:50:04', '', '0', '-1');
...
) ENGINE=MyISAM AUTO_INCREMENT=162 DEFAULT CHARSET=utf8mb4 COMMENT='菜单导航表';

-- ----------------------------
-- Records of tp5_xnav_menus
-- ----------------------------
INSERT INTO `tp5_xnav_menus` VALUES ('136', '查看商品操作日志', '50', 'cms/goods/viewLogs', '', '1', '0', '2020-03-09 17:45:57', '1');
INSERT INTO `tp5_xnav_menus` VALUES ('2', '菜单管理', '1', 'cms/menu/index', 'cms/images/icon/cms_menu_list.png', '1', '1', '2021-05-21 09:37:06', '0');
...
INSERT INTO `tp5_xnav_menus` VALUES ('1', '管理分配', '0', '/', 'cms/images/icon/cms_manage.png', '1', '1', '2021-05-20 17:50:38', '0');
...
INSERT INTO `tp5_xnav_menus` VALUES ('41', '增加角色', '7', 'cms/admin/addRole', '/', '1', '0', '2021-05-21 14:03:36', '1');
...
) ENGINE=MyISAM AUTO_INCREMENT=76 DEFAULT CHARSET=utf8mb4 COMMENT='管理平台 开发日志表';
...
-- ----------------------------
INSERT INTO `tp5_xskus` VALUES ('84', '1', 'cms/images/goods/1/1-1.jpg', '26', '桃桃红柚口味400ml 8杯', '49.90', '99', '4', '2021-05-20 17:49:54', '1');
INSERT INTO `tp5_xskus` VALUES ('85', '1', 'cms/images/goods/1/1-2.jpg', '27', '樱桃莓莓口味400ml 8杯', '49.90', '202', '5', '2021-05-20 17:49:54', '1');
INSERT INTO `tp5_xskus` VALUES ('86', '1', 'cms/images/goods/1/1-3.jpg', '28', '金桔柠檬口味400ml 8杯', '46.90', '200', '8', '2021-05-20 17:49:54', '0');
...
-- ----------------------------
INSERT INTO `tp5_xtest_logs` VALUES ('3744', '2353', '这是一个神奇的地方，', '', '1610161782');
